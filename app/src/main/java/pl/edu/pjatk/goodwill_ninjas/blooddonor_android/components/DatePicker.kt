...
import pl.edu.pjatk.goodwill_ninjas.blooddonor_android.components.calculator.DateChangeListener
import pl.edu.pjatk.goodwill_ninjas.blooddonor_android.components.calculator.DateListener
import pl.edu.pjatk.goodwill_ninjas.blooddonor_android.ui.theme.BlooddonorandroidTheme
import java.util.Calendar

@Composable
fun DatePicker(date: String, updateDate: (String) -> Unit
) {
            ...
            Row(modifier = Modifier.align(Alignment.CenterStart)) {
                ...
                Icon(
                    ...
                    modifier = Modifier
                        ...
                        .padding(4.dp)
                        .clickable {
//                            dateChangeListener.text = updateDate(date).toString()
